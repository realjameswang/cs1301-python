...
class Pet:
    def __init__(self, name, owner):
        ...
        # Each time you define a pet, it should automatically update the Owner.pets list.
        # Therefore, modifying Owner class will not yield anything, since you are only defining the Owner objects as the first 2 steps before even the pets are created.
        self.owner.pets.append(self) # trigger
