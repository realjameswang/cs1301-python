...
def total_stats(pokemon):
    #key: name, attack, defense, special_attack, special_defense, speed
    sum = 0
    pokemon_dict = {}
    for i in pokemon:
        sum = i["hp"] + i["attack"] + i["defense"] + i["special attack"] + i["special defense"] + i["speed"]
        pokemon_dict[i["name"]] = sum
    return pokemon_dict
