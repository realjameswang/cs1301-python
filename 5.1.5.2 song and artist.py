...
TaylorSwift = Artist("Taylor Swift", "Big Machine Records, LLC")
Lights = Artist("LiGHTS", "Warner Bros. Records Inc.")
song_1 = Song("You Belong With Me", "Fearless", 2008, TaylorSwift)
song_2 = Song("All Too Well", "Red", 2012, TaylorSwift)
